...
def plot_line(
    ...
    ax.axvline("2020-12-01", linestyle="--", linewidth=1, color="crimson")
    plt.text(
        "2020-12-01",
        ax.get_ylim()[1],
        "2020.12",
    ...
    # ax.axvline('2020-12-01', linestyle='--', linewidth=1, color='crimson')
    # plt.text('2020-12-01', ax.get_ylim()[1], '2020.12', ha='left', va='top',
    #          color='crimson', multialignment='center', fontproperties=myfont, fontsize=10)
    # ax.axvline('2020-12-01', linestyle='--', linewidth=1, color='crimson')
    # plt.text('2020-12-01', ax.get_ylim()[1], '2020.12', ha='left', va='top',
    #          color='crimson', multialignment='center', fontproperties=myfont, fontsize=10)
    # ax.axvline('2022-12-01', linestyle='--', linewidth=1, color='crimson')
    # plt.text('2022-12-01', ax.get_ylim()[1], '2022.12', ha='left', va='top',
    #          color='crimson', multialignment='center', fontproperties=myfont, fontsize=10)
    ...
    if table_data is not None:
        table = plt.table(
            cellText=table_data,
            rowLabels=["当前与预计2020全年表现", "当前与预计同比增长率"],
            # rowColours=['crimson', 'navy'],
            colLabels=["Actual YTD", "Actual MAT", "Trend-12M", "Trend-6M", "Trend-3M"],
            colColours=["pink", "deepskyblue", "crimson", "olivedrab", "darkorange"],
            loc="bottom",
            bbox=[0, -0.3, 1, 0.2],
        )
...
def plot_bubble_m(
    ...
    texts = [
        plt.text(
            x[i], y[i], labels[i], ha="center", va="center", multialignment="center", fontproperties=myfont, fontsize=10
        )
...
def plot_barh(
    ...
    ax = df.plot(
        ...
        alpha=0.8,
        edgecolor="black",
        color=["darkgreen", "olivedrab", "darkorange"],
    )  # ['navy','darkgreen','teal', 'crimson', 'grey']
    plt.title(title, fontproperties=myfont, fontsize=18)
    plt.xlabel(xtitle, fontproperties=myfont)
    plt.ylabel(ytitle, fontproperties=myfont)
